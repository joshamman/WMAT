<div class="wpdevart-header-container">
    ...
    <div class="wpdevart-logo-area">
        <div class="wpdevart-main-header-section-mobile-logo">
            <?php 
                ...
                <?php }
                else if ( !has_custom_logo() && is_front_page() && get_theme_mod( 'wpdevart_astrostar_header_logo_gradient_color' )) { ?>
                    <h1 class="wpdevart-logo-text-gradient"><a href="<?php echo esc_url(home_url()) ?>"><?php echo get_bloginfo('name') ?></a></h1>
                <?php }
                else if ( !has_custom_logo() && is_front_page() && empty(get_theme_mod( 'wpdevart_astrostar_header_logo_gradient_color' ))) { ?>
    ...
    <?php if (get_theme_mod( 'wpdevart_astrostar_header_show_action_button', '1' )) { } else { ?>
    <div class="header-action-button-mobile-area">
    <a href="<?php echo esc_url( get_theme_mod( 'wpdevart_astrostar_header_action_button_url' ) );  ?>"><div class="wpdevart_astrostar_hover_button_small wpdevart-header-action-button <?php echo esc_attr( get_theme_mod( 'wpdevart_astrostar_header_action_button_style' ) ); ?>"><?php echo esc_html( get_theme_mod( 'wpdevart_astrostar_header_action_button_text' ) );  ?></div></a>
    </div>
    <?php } ?>
    <div class="wpdevart-menu-and-buttons-area">
    <div class="wpdevart-menu-and-buttons-container">
    <div role="navigation" class="<?php if (get_theme_mod( 'wpdevart_astrostar_header_show_action_button', '1' )) { echo esc_attr('nav-container-without-action-button'); } else { echo esc_attr('nav-container-layout-one'); } ?>">
                    ...
                    <div id="head-mobile" class="<?php if (empty(get_theme_mod( 'wpdevart_astrostar_mobile_menu_bg_gradient_color' ))) 
    ...
    <?php if ( class_exists( 'WooCommerce' ) ) { ?>
            ...
            <div class="header-cart">
                <a class="cart-customlocation" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'astrostar' ); ?>">
				...
				<?php wpdevart_astrostar_header_cart_layout_one() ?>
            </div>   
    <?php } ?>
