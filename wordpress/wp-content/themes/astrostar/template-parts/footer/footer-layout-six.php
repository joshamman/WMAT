<footer class="<?php 
            ...
            if ( ( is_active_sidebar( 'wpdevart_astrostar_footer_large_widget' ) ) OR ( is_active_sidebar( 'wpdevart_astrostar_footer_widget_01' ) ) OR ( is_active_sidebar( 'wpdevart_astrostar_footer_widget_02' ) ) OR ( is_active_sidebar( 'wpdevart_astrostar_footer_widget_03' ) ) OR ( is_active_sidebar( 'wpdevart_astrostar_footer_widget_04' ) ) ) { ?>
                ...
                <div class="wpdevart-footer-container">
                    ...
                    <div class="site-footer-six-widgets-group">
                        ...
                        <div class="site-footer_six_col-four">
                            <div class="wpdevart-widgets-inner">
                                <?php
                                    if ( is_active_sidebar( 'wpdevart_astrostar_footer_widget_03' ) ) {
                                        dynamic_sidebar( 'wpdevart_astrostar_footer_widget_03' ); 
                                    } 
                                ?>    
                            </div>
                        </div>
                        <div class="site-footer_six_col-five">
                            <div class="wpdevart-widgets-inner">
                                <?php
                                    if ( is_active_sidebar( 'wpdevart_astrostar_footer_widget_04' ) ) {
                                        dynamic_sidebar( 'wpdevart_astrostar_footer_widget_04' ); 
                                    } 
                                ?>    
                            </div>
                        </div>
