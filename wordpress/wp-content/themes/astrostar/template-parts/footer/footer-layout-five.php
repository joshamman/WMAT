<footer class="<?php 
            ...
            if ( ( is_active_sidebar( 'wpdevart_astrostar_footer_large_widget' ) ) OR ( is_active_sidebar( 'wpdevart_astrostar_footer_widget_01' ) ) OR ( is_active_sidebar( 'wpdevart_astrostar_footer_widget_02' ) ) OR ( is_active_sidebar( 'wpdevart_astrostar_footer_widget_03' ) ) ) { ?>
