<?php if (has_post_thumbnail() ){ ?>
    <div class="wpdevart-images-hover-effect">
        <a href="<?php the_permalink(); ?>"> 
            <div class="<?php echo esc_attr( get_theme_mod( 'wpdevart_astrostar_posts_list_images_hover_effect' ) ); ?>"> 
...
<h2 class="post-list-title"><a href="<?php the_permalink(); ?>"><?php if( empty( $post->post_title ) ) { echo esc_html__( 'No Title', 'astrostar'); } else { echo esc_html(wp_trim_words(get_the_title(), 4)); } ?></a></h2>
</div>
