...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class wpdevart_astrostar_Section_Premium extends WP_Customize_Section {
	...
	class Wpdevart_Toggle_Switch_Custom_control extends WP_Customize_Control {
		public $type = 'wpdevart_astrostar_toggle_switch';
    ...
    class Wpdevart_Slider_Custom_Control extends WP_Customize_Control {
		public $type = 'wpdevart_astrostar_slider_control';
		public function render_content() {
		?>
    ...
    class Wpdevart_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		public $type = 'wpdevart_astrostar_image_radio_button';
		public function render_content() {
		?>
	...
	class Wpdevart_Premium_Features_List extends WP_Customize_Section {
		...
		public function json() {
			...
			$json['upsell_text']       = __( 'Upgrade Now', 'astrostar' );
	...
	class Wpdevart_Premium_Features_Control_List extends WP_Customize_Control {
		...
		public $type = 'control_wpdevart_astrostar_premium_features';
		public function render_content() {
			?>
				<div class="control-section-section-features-list">
					...
					<a href="<?php echo apply_filters( 'parent_wpdevart_astrostar_premium_features_url', esc_url('https://wpdevart.com/astrostar-wordpress-astrology-theme')); ?>" role="button" class="wpdevart-features-button-style" target="_blank"><?php echo esc_html__( 'Upgrade Now', 'astrostar' ); ?></a>
				</div>	
			<?php
		}
	}	
